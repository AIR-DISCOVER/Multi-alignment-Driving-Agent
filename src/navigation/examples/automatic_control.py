...
collision_path = r"C:\Users\gongj\Desktop\collision_00.txt"
times_path = r"C:\Users\gongj\Desktop\times_00.txt"
world_tick = 0
run_times = 0
waypoints_number = 0
last_action = "None"
            ...
            if agent.done():
                if args.loop:
                    ...
                    with open(times_path, 'a') as file:
                        times_record = "run_time_number: " + str(run_times) + " time ticks: " + str(world_tick) +  " waypoints: " + str(waypoints_number) + "\n"
                        file.write(times_record)
